...
meses.qmd            a grade de meses, montada a partir dos nomes dos arquivos
...
daquele mês — inclusive de um ano novo, porque o mês de uma ação vem do
prefixo `AAAA-MM` do nome do arquivo, e não de um ano fixo no código.
